...
/**
 * struct kev_shash_table_s - Sorted hash table data structure
 *
 * @size: The size of the array
 * @array: An array of size @size
 * Each cell of this array is a pointer to the first node of a linked list,
...
{
	unsigned long int size;
	kev_shash_node_t **array;
	kev_shash_node_t *shead;
	kev_shash_node_t *stail;
} kev_shash_table_t;
...
void shash_table_print(const kev_shash_table_t *ht);
void shash_table_print_rev(const kev_shash_table_t *ht);
